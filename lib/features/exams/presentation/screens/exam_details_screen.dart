...
//                     isPresent:
//                         item.absent?.toString().trim().toUpperCase() != 'N',
...
//                                     .fetchAttendanceDetails(widget.request);
//                               }
//                             },
//                             child: ListView(
//                               physics: const AlwaysScrollableScrollPhysics(),
...
//                                                             showMessage(
//                                                               'Maximum allowed mark is ${widget.maxTe}',
//                                                             );
//                                                           }
//                                                         },
//                                                         style: const TextStyle(
...
//                                                             showMessage(
//                                                               'Maximum allowed mark is ${widget.maxCe}',
//                                                             );
//                                                           }
//                                                         },
//                                                         style: const TextStyle(
...
class _ExamDetailsScreenState extends State<ExamDetailsScreen> {
  ...
  void saveDetails() {
    ...
    if (widget.isEditMode) {
      ...
      context.read<ExamCubit>().updateMarkEntry(
        UpdateMarkEntryParameter(
          markEntryId: widget.markEntryId!,
          employeeId: AppData.employeeId ?? 0,
          accYear: AppData.accYear ?? '',
          ...
          details: students.map((student) {
            return MarkEntryDetailParameter(
              admno: student.id,
              te: student.teController.text.trim(),
              ce: student.ceController.text.trim(),
              grade: student.grade,
    ...
    context.read<ExamCubit>().saveExamMarks(
      SaveExamMarksParameter(
        employeeId: AppData.employeeId ?? 0,
        accYear: AppData.accYear ?? '',
        standardId: widget.standardId,
        divisionId: widget.divisionId,
