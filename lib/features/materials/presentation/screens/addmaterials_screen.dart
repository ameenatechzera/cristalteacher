...
//       final String savedPath = path.join(temporaryDirectory.path, safeFileName);

//       final File copiedFile = File(savedPath);

//       if (pickedFile.bytes != null) {
//         await copiedFile.writeAsBytes(pickedFile.bytes!, flush: true);
...
//         _showMessage('Unable to prepare the selected file');
//         return;
//       }
...
//       debugPrint('Original filename: ${pickedFile.name}');
//       debugPrint('Saved upload file: ${copiedFile.path}');
//       debugPrint('File exists: ${await copiedFile.exists()}');
//       debugPrint('File size: ${await copiedFile.length()} bytes');
//     } catch (error, stackTrace) {
//       debugPrint('File selection failed: $error');
//       debugPrintStack(stackTrace: stackTrace);

//       _showMessage('Unable to select the file');
//     }
//   }
//   // Future<void> _chooseFile() async {
//   //   final FilePickerResult? result = await FilePicker.platform.pickFiles(
...
//                       decoration: selectedFilePath == null
